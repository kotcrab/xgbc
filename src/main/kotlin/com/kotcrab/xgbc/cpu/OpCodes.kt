...
fun generateOpCodes(emu: Emulator, cpu: Cpu, proc: OpCodesProcessor, op: Array<Instr?>) {
    ...
    op[0x31] = Instr(3, 12, "LD SP, d16", { cpu.sp = emu.read16(cpu.pc + 1) })
    op[0x32] = Instr(1, 8, "LD (HL-), A", {
        proc.ld8RegToReg16Addr(Reg16.HL, Reg.A)
        proc.dec16(Reg16.HL)
    })
    op[0x33] = Instr(1, 8, "INC SP", { cpu.sp += 1 })
    op[0x34] = Instr(1, 8, "INC (HL)", { proc.incHL() }, internalCycles = 4)
    op[0x35] = Instr(1, 8, "DEC (HL)", { proc.decHL() }, internalCycles = 4)
    op[0x36] = Instr(2, 8, "LD (HL), d8", {
    ...
    op[0x3B] = Instr(1, 8, "DEC SP", { cpu.sp -= 1 })
    ...
    op[0x76] = Instr(1, 4, "HALT", { cpu.halt = true })
    ...
    op[0xF3] = Instr(1, 4, "DI", { cpu.setImeFlag(false) })
    op[0xF4] = null
    ...
    op[0xF9] = Instr(1, 8, "LD SP, HL", { cpu.sp = cpu.readReg(Reg16.HL) })
    op[0xFA] = Instr(3, 8, "LD A, (a16)", { proc.ld8ImmAddrToReg(Reg.A) }, internalCycles = 8)
    op[0xFB] = Instr(1, 4, "EI", { cpu.setImeFlag(true) })
    op[0xFC] = null
    op[0xFD] = null
...
fun generateExtOpCodes(proc: OpCodesProcessor, op: Array<Instr?>) {
    ...
    op[0x06] = Instr(2, 8, "RLC (HL)", { proc.syncedHLRegOp({ proc.rlc(it, true) }) }, internalCycles = 8)
    ...
    op[0x0E] = Instr(2, 8, "RRC (HL)", { proc.syncedHLRegOp({ proc.rrc(it, true) }) }, internalCycles = 8)
    ...
    op[0x16] = Instr(2, 8, "RL (HL)", { proc.syncedHLRegOp({ proc.rl(it, true) }) }, internalCycles = 8)
    ...
    op[0x1E] = Instr(2, 8, "RR (HL)", { proc.syncedHLRegOp({ proc.rr(it, true) }) }, internalCycles = 8)
    ...
    op[0x26] = Instr(2, 8, "SLA (HL)", { proc.syncedHLRegOp({ proc.sla(it) }) }, internalCycles = 8)
    ...
    op[0x2E] = Instr(2, 8, "SRA (HL)", { proc.syncedHLRegOp({ proc.sra(it) }) }, internalCycles = 8)
    ...
    op[0x36] = Instr(2, 8, "SWAP (HL)", { proc.syncedHLRegOp({ proc.swap(it) }) }, internalCycles = 8)
    ...
    op[0x3E] = Instr(2, 8, "SRL (HL)", { proc.syncedHLRegOp({ proc.srl(it) }) }, internalCycles = 8)
    ...
    op[0x46] = Instr(2, 8, "BIT 0, (HL)", { proc.bitHL(0) }, internalCycles = 4)
    ...
    op[0x4E] = Instr(2, 8, "BIT 1, (HL)", { proc.bitHL(1) }, internalCycles = 4)
    ...
    op[0x56] = Instr(2, 8, "BIT 2, (HL)", { proc.bitHL(2) }, internalCycles = 4)
    ...
    op[0x5E] = Instr(2, 8, "BIT 3, (HL)", { proc.bitHL(3) }, internalCycles = 4)
    ...
    op[0x66] = Instr(2, 8, "BIT 4, (HL)", { proc.bitHL(4) }, internalCycles = 4)
    ...
    op[0x6E] = Instr(2, 8, "BIT 5, (HL)", { proc.bitHL(5) }, internalCycles = 4)
    ...
    op[0x76] = Instr(2, 8, "BIT 6, (HL)", { proc.bitHL(6) }, internalCycles = 4)
    ...
    op[0x7E] = Instr(2, 8, "BIT 7, (HL)", { proc.bitHL(7) }, internalCycles = 4)
    ...
    op[0x86] = Instr(2, 8, "RES 0, (HL)", { proc.syncedHLRegOp({ proc.res(0, it) }) }, internalCycles = 8)
    ...
    op[0x8E] = Instr(2, 8, "RES 1, (HL)", { proc.syncedHLRegOp({ proc.res(1, it) }) }, internalCycles = 8)
    ...
    op[0x96] = Instr(2, 8, "RES 2, (HL)", { proc.syncedHLRegOp({ proc.res(2, it) }) }, internalCycles = 8)
    ...
    op[0x9E] = Instr(2, 8, "RES 3, (HL)", { proc.syncedHLRegOp({ proc.res(3, it) }) }, internalCycles = 8)
    ...
    op[0xA6] = Instr(2, 8, "RES 4, (HL)", { proc.syncedHLRegOp({ proc.res(4, it) }) }, internalCycles = 8)
    ...
    op[0xAE] = Instr(2, 8, "RES 5, (HL)", { proc.syncedHLRegOp({ proc.res(5, it) }) }, internalCycles = 8)
    ...
    op[0xB6] = Instr(2, 8, "RES 6, (HL)", { proc.syncedHLRegOp({ proc.res(6, it) }) }, internalCycles = 8)
    ...
    op[0xBE] = Instr(2, 8, "RES 7, (HL)", { proc.syncedHLRegOp({ proc.res(7, it) }) }, internalCycles = 8)
    ...
    op[0xC6] = Instr(2, 8, "SET 0, (HL)", { proc.syncedHLRegOp({ proc.set(0, it) }) }, internalCycles = 8)
    ...
    op[0xCE] = Instr(2, 8, "SET 1, (HL)", { proc.syncedHLRegOp({ proc.set(1, it) }) }, internalCycles = 8)
    ...
    op[0xD6] = Instr(2, 8, "SET 2, (HL)", { proc.syncedHLRegOp({ proc.set(2, it) }) }, internalCycles = 8)
    ...
    op[0xDE] = Instr(2, 8, "SET 3, (HL)", { proc.syncedHLRegOp({ proc.set(3, it) }) }, internalCycles = 8)
    ...
    op[0xE6] = Instr(2, 8, "SET 4, (HL)", { proc.syncedHLRegOp({ proc.set(4, it) }) }, internalCycles = 8)
    ...
    op[0xEE] = Instr(2, 8, "SET 5, (HL)", { proc.syncedHLRegOp({ proc.set(5, it) }) }, internalCycles = 8)
    ...
    op[0xF6] = Instr(2, 8, "SET 6, (HL)", { proc.syncedHLRegOp({ proc.set(6, it) }) }, internalCycles = 8)
    ...
    op[0xFE] = Instr(2, 8, "SET 7, (HL)", { proc.syncedHLRegOp({ proc.set(7, it) }) }, internalCycles = 8)
