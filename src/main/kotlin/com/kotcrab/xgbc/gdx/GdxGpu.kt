...
class GdxGpu(private val gpu: Gpu) {
    ...
    fun drawPatternTileToPixmap(pixmap: Pixmap, xOffset: Int, yOffset: Int, patternTableAddr: Int, tileId: Int) {
        val buffer = gpu.readTilePatternTable(patternTableAddr, tileId, tmpTileBuffer)
