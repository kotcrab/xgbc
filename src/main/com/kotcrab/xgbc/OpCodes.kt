...
fun generateOpCodes(proc: OpCodesProcessor, op: Array<Instr?>) {
    ...
    op[0x26] = Instr(2, 8, "LD H, d8", { proc.ld8Imm(Cpu.REG_H) })
    ...
    op[0x2E] = Instr(2, 8, "LD L, d8", { proc.ld8Imm(Cpu.REG_L) })
    ...
    op[0x3B] = Instr(1, 8, "DEC SP", {})
    op[0x3C] = Instr(1, 4, "INC A", {})
    op[0x3D] = Instr(1, 4, "DEC A", {})
    op[0x3E] = Instr(2, 8, "LD A, d8", { proc.ld8Imm(Cpu.REG_A) })
    op[0x3F] = Instr(1, 4, "CCF", {})
    op[0x40] = Instr(1, 4, "LD B, B", { proc.ld8(Cpu.REG_B, Cpu.REG_B) })
    op[0x41] = Instr(1, 4, "LD B, C", { proc.ld8(Cpu.REG_B, Cpu.REG_C) })
    op[0x42] = Instr(1, 4, "LD B, D", { proc.ld8(Cpu.REG_B, Cpu.REG_D) })
    op[0x43] = Instr(1, 4, "LD B, E", { proc.ld8(Cpu.REG_B, Cpu.REG_E) })
    op[0x44] = Instr(1, 4, "LD B, H", { proc.ld8(Cpu.REG_B, Cpu.REG_H) })
    op[0x45] = Instr(1, 4, "LD B, L", { proc.ld8(Cpu.REG_B, Cpu.REG_L) })
    op[0x46] = Instr(1, 8, "LD B, (HL)", { proc.ld8FromReg16Addr(Cpu.REG_B, Cpu.REG_HL) })
    op[0x47] = Instr(1, 4, "LD B, A", { proc.ld8(Cpu.REG_B, Cpu.REG_A) })
    op[0x48] = Instr(1, 4, "LD C, B", { proc.ld8(Cpu.REG_C, Cpu.REG_B) })
    op[0x49] = Instr(1, 4, "LD C, C", { proc.ld8(Cpu.REG_C, Cpu.REG_C) })
    op[0x4A] = Instr(1, 4, "LD C, D", { proc.ld8(Cpu.REG_C, Cpu.REG_D) })
    op[0x4B] = Instr(1, 4, "LD C, E", { proc.ld8(Cpu.REG_C, Cpu.REG_E) })
    op[0x4C] = Instr(1, 4, "LD C, H", { proc.ld8(Cpu.REG_C, Cpu.REG_H) })
    op[0x4D] = Instr(1, 4, "LD C, L", { proc.ld8(Cpu.REG_C, Cpu.REG_L) })
    op[0x4E] = Instr(1, 8, "LD C, (HL)", { proc.ld8FromReg16Addr(Cpu.REG_C, Cpu.REG_HL) })
    op[0x4F] = Instr(1, 4, "LD C, A", { proc.ld8(Cpu.REG_C, Cpu.REG_A) })
    op[0x50] = Instr(1, 4, "LD D, B", { proc.ld8(Cpu.REG_D, Cpu.REG_B) })
    op[0x51] = Instr(1, 4, "LD D, C", { proc.ld8(Cpu.REG_D, Cpu.REG_C) })
    op[0x52] = Instr(1, 4, "LD D, D", { proc.ld8(Cpu.REG_D, Cpu.REG_D) })
    op[0x53] = Instr(1, 4, "LD D, E", { proc.ld8(Cpu.REG_D, Cpu.REG_E) })
    op[0x54] = Instr(1, 4, "LD D, H", { proc.ld8(Cpu.REG_D, Cpu.REG_H) })
    op[0x55] = Instr(1, 4, "LD D, L", { proc.ld8(Cpu.REG_D, Cpu.REG_L) })
    op[0x56] = Instr(1, 8, "LD D, (HL)", { proc.ld8FromReg16Addr(Cpu.REG_D, Cpu.REG_HL) })
    op[0x57] = Instr(1, 4, "LD D, A", { proc.ld8(Cpu.REG_D, Cpu.REG_A) })
    op[0x58] = Instr(1, 4, "LD E, B", { proc.ld8(Cpu.REG_E, Cpu.REG_B) })
    op[0x59] = Instr(1, 4, "LD E, C", { proc.ld8(Cpu.REG_E, Cpu.REG_C) })
    op[0x5A] = Instr(1, 4, "LD E, D", { proc.ld8(Cpu.REG_E, Cpu.REG_D) })
    op[0x5B] = Instr(1, 4, "LD E, E", { proc.ld8(Cpu.REG_E, Cpu.REG_E) })
    op[0x5C] = Instr(1, 4, "LD E, H", { proc.ld8(Cpu.REG_E, Cpu.REG_H) })
    op[0x5D] = Instr(1, 4, "LD E, L", { proc.ld8(Cpu.REG_E, Cpu.REG_L) })
    op[0x5E] = Instr(1, 8, "LD E, (HL)", { proc.ld8FromReg16Addr(Cpu.REG_E, Cpu.REG_HL) })
    op[0x5F] = Instr(1, 4, "LD E, A", { proc.ld8(Cpu.REG_E, Cpu.REG_A) })
    op[0x60] = Instr(1, 4, "LD H, B", { proc.ld8(Cpu.REG_H, Cpu.REG_B) })
    op[0x61] = Instr(1, 4, "LD H, C", { proc.ld8(Cpu.REG_H, Cpu.REG_C) })
    op[0x62] = Instr(1, 4, "LD H, D", { proc.ld8(Cpu.REG_H, Cpu.REG_D) })
    op[0x63] = Instr(1, 4, "LD H, E", { proc.ld8(Cpu.REG_H, Cpu.REG_E) })
    op[0x64] = Instr(1, 4, "LD H, H", { proc.ld8(Cpu.REG_H, Cpu.REG_H) })
    op[0x65] = Instr(1, 4, "LD H, L", { proc.ld8(Cpu.REG_H, Cpu.REG_L) })
    op[0x66] = Instr(1, 8, "LD H, (HL)", { proc.ld8FromReg16Addr(Cpu.REG_H, Cpu.REG_HL) })
    op[0x67] = Instr(1, 4, "LD H, A", { proc.ld8(Cpu.REG_H, Cpu.REG_A) })
    op[0x68] = Instr(1, 4, "LD L, B", { proc.ld8(Cpu.REG_L, Cpu.REG_B) })
    op[0x69] = Instr(1, 4, "LD L, C", { proc.ld8(Cpu.REG_L, Cpu.REG_C) })
    op[0x6A] = Instr(1, 4, "LD L, D", { proc.ld8(Cpu.REG_L, Cpu.REG_D) })
    op[0x6B] = Instr(1, 4, "LD L, E", { proc.ld8(Cpu.REG_L, Cpu.REG_E) })
    op[0x6C] = Instr(1, 4, "LD L, H", { proc.ld8(Cpu.REG_L, Cpu.REG_H) })
    op[0x6D] = Instr(1, 4, "LD L, L", { proc.ld8(Cpu.REG_L, Cpu.REG_L) })
    op[0x6E] = Instr(1, 8, "LD L, (HL)", { proc.ld8FromReg16Addr(Cpu.REG_L, Cpu.REG_HL) })
    op[0x6F] = Instr(1, 4, "LD L, A", { proc.ld8(Cpu.REG_L, Cpu.REG_A) })
    op[0x70] = Instr(1, 8, "LD (HL), B", { proc.ld8ToReg16Addr(Cpu.REG_HL, Cpu.REG_B) })
    op[0x71] = Instr(1, 8, "LD (HL), C", { proc.ld8ToReg16Addr(Cpu.REG_HL, Cpu.REG_C) })
    op[0x72] = Instr(1, 8, "LD (HL), D", { proc.ld8ToReg16Addr(Cpu.REG_HL, Cpu.REG_D) })
    op[0x73] = Instr(1, 8, "LD (HL), E", { proc.ld8ToReg16Addr(Cpu.REG_HL, Cpu.REG_E) })
    op[0x74] = Instr(1, 8, "LD (HL), H", { proc.ld8ToReg16Addr(Cpu.REG_HL, Cpu.REG_H) })
    op[0x75] = Instr(1, 8, "LD (HL), L", { proc.ld8ToReg16Addr(Cpu.REG_HL, Cpu.REG_L) })
    op[0x76] = Instr(1, 4, "HALT", {})
    op[0x77] = Instr(1, 8, "LD (HL), A", { proc.ld8ToReg16Addr(Cpu.REG_HL, Cpu.REG_A) })
    op[0x78] = Instr(1, 4, "LD A, B", { proc.ld8(Cpu.REG_A, Cpu.REG_B) })
    op[0x79] = Instr(1, 4, "LD A, C", { proc.ld8(Cpu.REG_A, Cpu.REG_C) })
    op[0x7A] = Instr(1, 4, "LD A, D", { proc.ld8(Cpu.REG_A, Cpu.REG_D) })
    op[0x7B] = Instr(1, 4, "LD A, E", { proc.ld8(Cpu.REG_A, Cpu.REG_E) })
    op[0x7C] = Instr(1, 4, "LD A, H", { proc.ld8(Cpu.REG_A, Cpu.REG_H) })
    op[0x7D] = Instr(1, 4, "LD A, L", { proc.ld8(Cpu.REG_A, Cpu.REG_L) })
    op[0x7E] = Instr(1, 8, "LD A, (HL)", { proc.ld8FromReg16Addr(Cpu.REG_A, Cpu.REG_HL) })
    op[0x7F] = Instr(1, 4, "LD A, A", { proc.ld8(Cpu.REG_A, Cpu.REG_A) })
    op[0x80] = Instr(1, 4, "ADD A, B", {})
    op[0x81] = Instr(1, 4, "ADD A, C", {})
    op[0x82] = Instr(1, 4, "ADD A, D", {})
    op[0x83] = Instr(1, 4, "ADD A, E", {})
    op[0x84] = Instr(1, 4, "ADD A, H", {})
    op[0x85] = Instr(1, 4, "ADD A, L", {})
    op[0x86] = Instr(1, 8, "ADD A, (HL)", {})
    op[0x87] = Instr(1, 4, "ADD A, A", {})
    op[0x88] = Instr(1, 4, "ADC A, B", {})
    op[0x89] = Instr(1, 4, "ADC A, C", {})
    op[0x8A] = Instr(1, 4, "ADC A, D", {})
    op[0x8B] = Instr(1, 4, "ADC A, E", {})
    op[0x8C] = Instr(1, 4, "ADC A, H", {})
    op[0x8D] = Instr(1, 4, "ADC A, L", {})
    op[0x8E] = Instr(1, 8, "ADC A, (HL)", {})
    op[0x8F] = Instr(1, 4, "ADC A, A", {})
    op[0x90] = Instr(1, 4, "SUB B", {})
    op[0x91] = Instr(1, 4, "SUB C", {})
    op[0x92] = Instr(1, 4, "SUB D", {})
    op[0x93] = Instr(1, 4, "SUB E", {})
    op[0x94] = Instr(1, 4, "SUB H", {})
    op[0x95] = Instr(1, 4, "SUB L", {})
    op[0x96] = Instr(1, 8, "SUB (HL)", {})
    op[0x97] = Instr(1, 4, "SUB A", {})
    op[0x98] = Instr(1, 4, "SBC A, B", {})
    op[0x99] = Instr(1, 4, "SBC A, C", {})
    op[0x9A] = Instr(1, 4, "SBC A, D", {})
    op[0x9B] = Instr(1, 4, "SBC A, E", {})
    op[0x9C] = Instr(1, 4, "SBC A, H", {})
    op[0x9D] = Instr(1, 4, "SBC A, L", {})
    op[0x9E] = Instr(1, 8, "SBC A, (HL)", {})
    op[0x9F] = Instr(1, 4, "SBC A, A", {})
    op[0xA0] = Instr(1, 4, "AND B", {})
    op[0xA1] = Instr(1, 4, "AND C", {})
    op[0xA2] = Instr(1, 4, "AND D", {})
    op[0xA3] = Instr(1, 4, "AND E", {})
    op[0xA4] = Instr(1, 4, "AND H", {})
    op[0xA5] = Instr(1, 4, "AND L", {})
    op[0xA6] = Instr(1, 8, "AND (HL)", {})
    op[0xA7] = Instr(1, 4, "AND A", {})
    op[0xA8] = Instr(1, 4, "XOR B", {})
    op[0xA9] = Instr(1, 4, "XOR C", {})
    op[0xAA] = Instr(1, 4, "XOR D", {})
    op[0xAB] = Instr(1, 4, "XOR E", {})
    op[0xAC] = Instr(1, 4, "XOR H", {})
    op[0xAD] = Instr(1, 4, "XOR L", {})
    op[0xAE] = Instr(1, 8, "XOR (HL)", {})
    op[0xAF] = Instr(1, 4, "XOR A", {})
    op[0xB0] = Instr(1, 4, "OR B", {})
    op[0xB1] = Instr(1, 4, "OR C", {})
    op[0xB2] = Instr(1, 4, "OR D", {})
    op[0xB3] = Instr(1, 4, "OR E", {})
    op[0xB4] = Instr(1, 4, "OR H", {})
    op[0xB5] = Instr(1, 4, "OR L", {})
    op[0xB6] = Instr(1, 8, "OR (HL)", {})
    op[0xB7] = Instr(1, 4, "OR A", {})
    op[0xB8] = Instr(1, 4, "CP B", {})
    op[0xB9] = Instr(1, 4, "CP C", {})
    op[0xBA] = Instr(1, 4, "CP D", {})
    op[0xBB] = Instr(1, 4, "CP E", {})
    op[0xBC] = Instr(1, 4, "CP H", {})
    op[0xBD] = Instr(1, 4, "CP L", {})
    op[0xBE] = Instr(1, 8, "CP (HL)", {})
    op[0xBF] = Instr(1, 4, "CP A", {})
    op[0xC0] = CondInstr(1, 20, 8, "RET NZ", { false })
    op[0xC1] = Instr(1, 12, "POP BC", {})
    op[0xC2] = CondInstr(3, 16, 12, "JP NZ, a16", { false })
    op[0xC3] = Instr(3, 16, "JP a16", {})
    op[0xC4] = CondInstr(3, 24, 12, "CALL NZ, a16", { false })
    op[0xC5] = Instr(1, 16, "PUSH BC", {})
    op[0xC6] = Instr(2, 8, "ADD A, d8", {})
    ...
    op[0xFA] = Instr(3, 16, "LD A, (a16)", { proc.ld8Imm16(Cpu.REG_A) })
