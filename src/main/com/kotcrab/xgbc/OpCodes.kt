...
fun generateOpCodes(proc: OpCodesProcessor, op: Array<Instr?>) {
    ...
    op[0x3E] = Instr(2, 8, "LD A, d8", {})
    op[0x3F] = Instr(1, 4, "CCF", {})
    op[0x40] = Instr(1, 4, "LD B, B", {})
    op[0x41] = Instr(1, 4, "LD B, C", {})
    op[0x42] = Instr(1, 4, "LD B, D", {})
    op[0x43] = Instr(1, 4, "LD B, E", {})
    op[0x44] = Instr(1, 4, "LD B, H", {})
    op[0x45] = Instr(1, 4, "LD B, L", {})
    op[0x46] = Instr(1, 8, "LD B, (HL)", {})
    op[0x47] = Instr(1, 4, "LD B, A", {})
    op[0x48] = Instr(1, 4, "LD C, B", {})
    op[0x49] = Instr(1, 4, "LD C, C", {})
    op[0x4A] = Instr(1, 4, "LD C, D", {})
    op[0x4B] = Instr(1, 4, "LD C, E", {})
    op[0x4C] = Instr(1, 4, "LD C, H", {})
    op[0x4D] = Instr(1, 4, "LD C, L", {})
    op[0x4E] = Instr(1, 8, "LD C, (HL)", {})
    op[0x4F] = Instr(1, 4, "LD C, A", {})
    op[0x50] = Instr(1, 4, "LD D, B", {})
    op[0x51] = Instr(1, 4, "LD D, C", {})
    op[0x52] = Instr(1, 4, "LD D, D", {})
    op[0x53] = Instr(1, 4, "LD D, E", {})
    op[0x54] = Instr(1, 4, "LD D, H", {})
    op[0x55] = Instr(1, 4, "LD D, L", {})
    op[0x56] = Instr(1, 8, "LD D, (HL)", {})
    op[0x57] = Instr(1, 4, "LD D, A", {})
    op[0x58] = Instr(1, 4, "LD E, B", {})
    op[0x59] = Instr(1, 4, "LD E, C", {})
    op[0x5A] = Instr(1, 4, "LD E, D", {})
    op[0x5B] = Instr(1, 4, "LD E, E", {})
    op[0x5C] = Instr(1, 4, "LD E, H", {})
    op[0x5D] = Instr(1, 4, "LD E, L", {})
    op[0x5E] = Instr(1, 8, "LD E, (HL)", {})
    op[0x5F] = Instr(1, 4, "LD E, A", {})
    op[0x60] = Instr(1, 4, "LD H, B", {})
    op[0x61] = Instr(1, 4, "LD H, C", {})
    op[0x62] = Instr(1, 4, "LD H, D", {})
    op[0x63] = Instr(1, 4, "LD H, E", {})
    op[0x64] = Instr(1, 4, "LD H, H", {})
    op[0x65] = Instr(1, 4, "LD H, L", {})
    op[0x66] = Instr(1, 8, "LD H, (HL)", {})
    op[0x67] = Instr(1, 4, "LD H, A", {})
    op[0x68] = Instr(1, 4, "LD L, B", {})
    op[0x69] = Instr(1, 4, "LD L, C", {})
    op[0x6A] = Instr(1, 4, "LD L, D", {})
    op[0x6B] = Instr(1, 4, "LD L, E", {})
    op[0x6C] = Instr(1, 4, "LD L, H", {})
    op[0x6D] = Instr(1, 4, "LD L, L", {})
    op[0x6E] = Instr(1, 8, "LD L, (HL)", {})
    op[0x6F] = Instr(1, 4, "LD L, A", {})
    op[0x70] = Instr(1, 8, "LD (HL), B", {})
    op[0x71] = Instr(1, 8, "LD (HL), C", {})
    op[0x72] = Instr(1, 8, "LD (HL), D", {})
    op[0x73] = Instr(1, 8, "LD (HL), E", {})
    op[0x74] = Instr(1, 8, "LD (HL), H", {})
    op[0x75] = Instr(1, 8, "LD (HL), L", {})
    op[0x76] = Instr(1, 4, "HALT", {})
    op[0x77] = Instr(1, 8, "LD (HL), A", {})
    op[0x78] = Instr(1, 4, "LD A, B", {})
    op[0x79] = Instr(1, 4, "LD A, C", {})
    op[0x7A] = Instr(1, 4, "LD A, D", {})
    op[0x7B] = Instr(1, 4, "LD A, E", {})
    op[0x7C] = Instr(1, 4, "LD A, H", {})
    op[0x7D] = Instr(1, 4, "LD A, L", {})
    op[0x7E] = Instr(1, 8, "LD A, (HL)", {})
    op[0x7F] = Instr(1, 4, "LD A, A", {})
